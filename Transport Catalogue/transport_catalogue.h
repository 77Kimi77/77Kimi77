...
namespace transport {
    ...
    public:
        ...
        void AddStop(std::string_view stop_name, const geo::Coordinates coordinates_);
        void AddRoute(std::string_view bus_number, const std::vector<const Stop*> stops_, bool is_circle_);
